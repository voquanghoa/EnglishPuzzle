...
import com.qhvv.englishpuzzle.util.GifDecoder;

import java.io.IOException;

/**
 * Created by voqua on 10/21/2015.
 */
public class GifImageView extends ImageView implements Runnable {
    ...
    private void loadImage(){
        try {
            setBytes(AssertDataController.getInstance().readAsByteArray(getContext(),getTag().toString()));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
